...
Patch 3.0.2 introduces the full Omega Cache rollout for housing and crafting. This adds house-based cache placement, cache command support, and cache-aware material handling across core crafting systems.

Players should notice much faster material management for crafting sessions, fewer backpack bottlenecks, and better storage flow when working from owned houses.
...
- Supporting command synopsis and include-layer plumbing were updated for full integration.
